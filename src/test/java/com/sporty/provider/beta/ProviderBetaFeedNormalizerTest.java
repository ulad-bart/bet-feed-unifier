...
class ProviderBetaFeedNormalizerTest {

  private final ProviderBetaFeedNormalizer normalizer = new ProviderBetaFeedNormalizer();

  @Test
  void normalize_oddsRequest_mapsToStandardOddsChangeMessage() {
